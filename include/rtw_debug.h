...
#define RTW_PRINT(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define RTW_ERR(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define RTW_WARN(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define RTW_INFO(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define RTW_DBG(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define RTW_PRINT_SEL(sel, fmt, ...) do { if (0) { (void)(sel); no_printk(fmt, ##__VA_ARGS__); } } while (0)
#define _RTW_PRINT(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define _RTW_ERR(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define _RTW_WARN(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define _RTW_INFO(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define _RTW_DBG(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define _RTW_PRINT_SEL(sel, fmt, ...) do { if (0) { (void)(sel); no_printk(fmt, ##__VA_ARGS__); } } while (0)

#define RTW_PRINT_LMT(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define RTW_ERR_LMT(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define RTW_WARN_LMT(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define RTW_INFO_LMT(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define RTW_DBG_LMT(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define _RTW_PRINT_LMT(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define _RTW_ERR_LMT(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define _RTW_WARN_LMT(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define _RTW_INFO_LMT(fmt, ...) no_printk(fmt, ##__VA_ARGS__)
#define _RTW_DBG_LMT(fmt, ...) no_printk(fmt, ##__VA_ARGS__)

#define RTW_INFO_DUMP(_TitleString, _HexData, _HexDataLen) \
	do { if (0) { (void)(_TitleString); (void)(_HexData); (void)(_HexDataLen); } } while (0)
