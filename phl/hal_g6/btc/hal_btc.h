...
enum btc_bt_dev_info {
	BTC_BT_INFO_HID_LIST = 0x0,
	BTC_BT_INFO_HID_VINFO = 0x1,
	BTC_BT_INFO_HID_DNAME =  0x2,
	BTC_BT_INFO_HID_BINFO = 0x3,

	BTC_BT_INFO_A2DP_LIST = 0x10,
	BTC_BT_INFO_A2DP_BINFO = 0x11,

	BTC_BT_INFO_PAN_LIST = 0x20,
	BTC_BT_INFO_PAN_BINFO = 0x21
};
...
struct btc_bt_hfp_desc {
	...
	u8 cnt;
	u8 lists[BTC_BT_INFO_LINK_MAX];
	struct btc_bt_link_hfp links[BTC_BT_INFO_LINK_MAX];
};
...
struct btc_bt_hid_desc {
	...
	u8 cnt;
	u8 lists[BTC_BT_INFO_LINK_MAX];
	struct btc_bt_link_hid links[BTC_BT_INFO_LINK_MAX];
};
...
struct btc_bt_a2dp_desc {
	...
	u8 cnt;
	u8 lists[BTC_BT_INFO_LINK_MAX];
	struct btc_bt_link_a2dp links[BTC_BT_INFO_LINK_MAX];
};
...
struct btc_bt_pan_desc {
	...
	u8 cnt;
	u8 lists[BTC_BT_INFO_LINK_MAX];
	struct btc_bt_link_pan links[BTC_BT_INFO_LINK_MAX];
};
...
struct btc_dm {
	...
	u8 nhm_rpt_freq; /* nhm report update freq (num of ntfy_sta/run_coex) */
};
